...
%% This code generates tumor growth data 'cell_history', 'cellXY',  %%
%% and 'cellID' used in all routines for visualization of the 3D    %%
%% linage trees of the tumor.                                       %%
%%                                                                  %%
