function linG3DAliveClone(pathdata,cloneNum)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 toPrint=0;            % save the final figure 
 ...
 cellID=load([pathdata,dataDirectory,'cellID_',num2str(tmax),'.txt']);
  ...
  % identify all ssurvivrd cells from a given clone 
  indLast=[]; Nlast=0;
...
% define matrix of line segments (3D branches) to draw
  ...
  title(['survived cells from clone=',num2str(cloneNum)])
  axis equal
  axis([xmin,xmax,tmin,tmax/timeStep,ymin,ymax])
  view(3)
  ...
  if toPrint==1
    print('-djpeg100',[pathFigs,'/tree_alive_clone_',num2str(cloneNum),'.jpg'])
  end
